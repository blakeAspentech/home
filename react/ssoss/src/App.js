    ...
    <div className="App">
      <header className="App-header">
        ...
        <svg id="title" width="100%" viewBox="-20 0 520 300" xmlns="http://www.w3.org/2000/svg" alt="SSOSS">
          ...
          <path d="M 237.5 400 l 0 -500" stroke="red" stroke-width="1" fill="none"/>
          <path className="curve" id="curveBottom" d="M 200 200 a 10 10 0 0 0 75 0" stroke="white" stroke-width="12" fill="none"/>
          <path className="curve" id="curveTop" d="M 200 200 a 10 10 0 0 0 75 0" stroke="white" stroke-width="12" fill="none"/>
